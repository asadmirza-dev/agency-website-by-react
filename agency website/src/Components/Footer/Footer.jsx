...
const Footer = () => {
  return (
    <div className=' dark:bg-gray-900 w-full flex flex-col items-center  gap-10 min-h-[40vh] bg-gry-50 text-white '>
      ...
      <div className="footer-right w-[30%] flex flex-col items-start justify-start gap-4 ">
        <h2 className='text-2xl font-medium  text-gray-800 dark:text-white'>Subscribe to Our Newsletter</h2>
        <p className='text-xl font-medium  text-gray-600 dark:text-gray-300'>Stay updated with our latest news and offers.</p>
        <div className="email flex items-center w-full">
      ...
      <div className="copyright className='text-gray-600 text-xl font-medium ">
